...
- Hardware smoke test on Pico should verify display format (e.g., `HAM - 01:37.154`).
...
- Never commit real secrets; replace `WIFI_SSID`, `WIFI_PASSWORD`, and sensitive URLs with safe values before pushing.
